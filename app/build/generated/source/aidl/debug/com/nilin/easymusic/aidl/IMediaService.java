 ...
 * Original file: D:\\nilin\\EasyMusic\\app\\src\\main\\aidl\\com\\nilin\\easymusic\\aidl\\IMediaService.aidl
 */
package com.nilin.easymusic.aidl;
public interface IMediaService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.nilin.easymusic.aidl.IMediaService
{
private static final java.lang.String DESCRIPTOR = "com.nilin.easymusic.aidl.IMediaService";
...
/**
 * Cast an IBinder object into an com.nilin.easymusic.aidl.IMediaService interface,
 * generating a proxy if needed.
 */
public static com.nilin.easymusic.aidl.IMediaService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.nilin.easymusic.aidl.IMediaService))) {
return ((com.nilin.easymusic.aidl.IMediaService)iin);
}
return new com.nilin.easymusic.aidl.IMediaService.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
java.util.List<com.nilin.easymusic.model.MusicInfo> _arg0;
_arg0 = data.createTypedArrayList(com.nilin.easymusic.model.MusicInfo.CREATOR);
...
data.enforceInterface(DESCRIPTOR);
java.util.List<com.nilin.easymusic.model.MusicInfo> _arg0;
_arg0 = new java.util.ArrayList<com.nilin.easymusic.model.MusicInfo>();
...
{
data.enforceInterface(DESCRIPTOR);
com.nilin.easymusic.model.MusicInfo _result = this.getCurMusic();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
private static class Proxy implements com.nilin.easymusic.aidl.IMediaService
{
...
@Override public void refreshMusicList(java.util.List<com.nilin.easymusic.model.MusicInfo> musicList) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void getMusicList(java.util.List<com.nilin.easymusic.model.MusicInfo> musicList) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_reply.readException();
_reply.readTypedList(musicList, com.nilin.easymusic.model.MusicInfo.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
...
@Override public com.nilin.easymusic.model.MusicInfo getCurMusic() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.nilin.easymusic.model.MusicInfo _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getCurMusic, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.nilin.easymusic.model.MusicInfo.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
public void refreshMusicList(java.util.List<com.nilin.easymusic.model.MusicInfo> musicList) throws android.os.RemoteException;
public void getMusicList(java.util.List<com.nilin.easymusic.model.MusicInfo> musicList) throws android.os.RemoteException;
...
public com.nilin.easymusic.model.MusicInfo getCurMusic() throws android.os.RemoteException;
}
